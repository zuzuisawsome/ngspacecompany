    ...
    <div class="row g-3">
        <div v-if="countTo50 > 0" class="col-12">
            ...
            <div class="row g-1">
                ...
                <div class="col-auto">
                    <small class="text-uppercase" :class="{ 'text-light':costTo50.gold.count <= data['gold'].storage, 'text-excess':costTo50.gold.count <= getStorageCap('gold') && costTo50.gold.count > data['gold'].storage, 'text-danger':costTo50.gold.count > getStorageCap('gold') }"><format-number :value="costTo50.gold.count" /></small>
                </div>
                <div class="col-auto text-end" style="width:75px">
            ...
            <div class="row g-1">
                ...
                <div class="col-auto">
                    <small class="text-uppercase" :class="{ 'text-light':costTo50.silicon.count <= data['silicon'].storage, 'text-excess':costTo50.silicon.count <= getStorageCap('silicon') && costTo50.silicon.count > data['silicon'].storage, 'text-danger':costTo50.silicon.count > getStorageCap('silicon') }"><format-number :value="costTo50.silicon.count" /></small>
                </div>
                <div class="col-auto text-end" style="width:75px">
            ...
            <div class="row g-1">
                ...
                <div class="col-auto">
                    <small class="text-uppercase" :class="{ 'text-light':costTo50.meteorite.count <= data['meteorite'].storage, 'text-excess':costTo50.meteorite.count <= getStorageCap('meteorite') && costTo50.meteorite.count > data['meteorite'].storage, 'text-danger':costTo50.meteorite.count > getStorageCap('meteorite') }"><format-number :value="costTo50.meteorite.count" /></small>
                </div>
                <div class="col-auto text-end" style="width:75px">
            ...
            <div class="row g-1">
                ...
                <div class="col-auto">
                    <small class="text-uppercase" :class="{ 'text-light':costTo50.ice.count <= data['ice'].storage, 'text-excess':costTo50.ice.count <= getStorageCap('ice') && costTo50.ice.count > data['ice'].storage, 'text-danger':costTo50.ice.count > getStorageCap('ice') }"><format-number :value="costTo50.ice.count" /></small>
                </div>
                <div class="col-auto text-end" style="width:75px">
        ...
        <div v-if="countTo100 > 0" class="col-12">
            ...
            <div class="row g-1">
                ...
                <div class="col-auto">
                    <small class="text-uppercase" :class="{ 'text-light':costTo100.gold.count <= data['gold'].storage, 'text-excess':costTo100.gold.count <= getStorageCap('gold') && costTo100.gold.count > data['gold'].storage, 'text-danger':costTo100.gold.count > getStorageCap('gold') }"><format-number :value="costTo100.gold.count" /></small>
                </div>
                <div class="col-auto text-end" style="width:75px">
                    <small v-if="data['gold'].prod <= 0" class="text-normal">---</small>
            ...
            <div class="row g-1">
                ...
                <div class="col-auto">
                    <small class="text-uppercase" :class="{ 'text-light':costTo100.silicon.count <= data['silicon'].storage, 'text-excess':costTo100.silicon.count <= getStorageCap('silicon') && costTo100.silicon.count > data['silicon'].storage, 'text-danger':costTo100.silicon.count > getStorageCap('silicon') }"><format-number :value="costTo100.silicon.count" /></small>
                </div>
                <div class="col-auto text-end" style="width:75px">
                    <small v-if="data['silicon'].prod <= 0" class="text-normal">---</small>
            ...
            <div class="row g-1">
                ...
                <div class="col-auto">
                    <small class="text-uppercase" :class="{ 'text-light':costTo100.meteorite.count <= data['meteorite'].storage, 'text-excess':costTo100.meteorite.count <= getStorageCap('meteorite') && costTo100.meteorite.count > data['meteorite'].storage, 'text-danger':costTo100.meteorite.count > getStorageCap('meteorite') }"><format-number :value="costTo100.meteorite.count" /></small>
                </div>
                <div class="col-auto text-end" style="width:75px">
                    <small v-if="data['meteorite'].prod <= 0" class="text-normal">---</small>
            ...
            <div class="row g-1">
                ...
                <div class="col-auto">
                    <small class="text-uppercase" :class="{ 'text-light':costTo100.ice.count <= data['ice'].storage, 'text-excess':costTo100.ice.count <= getStorageCap('ice') && costTo100.ice.count > data['ice'].storage, 'text-danger':costTo100.ice.count > getStorageCap('ice') }"><format-number :value="costTo100.ice.count" /></small>
                </div>
                <div class="col-auto text-end" style="width:75px">
                    <small v-if="data['ice'].prod <= 0" class="text-normal">---</small>
        ...
        <div v-if="countTo250 > 0" class="col-12">
            ...
            <div class="row g-1">
                ...
                <div class="col-auto">
                    <small class="text-uppercase" :class="{ 'text-light':costTo250.gold.count <= data['gold'].storage, 'text-excess':costTo250.gold.count <= getStorageCap('gold') && costTo250.gold.count > data['gold'].storage, 'text-danger':costTo250.gold.count > getStorageCap('gold') }"><format-number :value="costTo250.gold.count" /></small>
                </div>
                <div class="col-auto text-end" style="width:75px">
                    <small v-if="data['gold'].prod <= 0" class="text-normal">---</small>
            ...
            <div class="row g-1">
                ...
                <div class="col-auto">
                    <small class="text-uppercase" :class="{ 'text-light':costTo250.silicon.count <= data['silicon'].storage, 'text-excess':costTo250.silicon.count <= getStorageCap('silicon') && costTo250.silicon.count > data['silicon'].storage, 'text-danger':costTo250.silicon.count > getStorageCap('silicon') }"><format-number :value="costTo250.silicon.count" /></small>
                </div>
                <div class="col-auto text-end" style="width:75px">
                    <small v-if="data['silicon'].prod <= 0" class="text-normal">---</small>
            ...
            <div class="row g-1">
                ...
                <div class="col-auto">
                    <small class="text-uppercase" :class="{ 'text-light':costTo250.meteorite.count <= data['meteorite'].storage, 'text-excess':costTo250.meteorite.count <= getStorageCap('meteorite') && costTo250.meteorite.count > data['meteorite'].storage, 'text-danger':costTo250.meteorite.count > getStorageCap('meteorite') }"><format-number :value="costTo250.meteorite.count" /></small>
                </div>
                <div class="col-auto text-end" style="width:75px">
                    <small v-if="data['meteorite'].prod <= 0" class="text-normal">---</small>
            ...
            <div class="row g-1">
                ...
                <div class="col-auto">
                    <small class="text-uppercase" :class="{ 'text-light':costTo250.ice.count <= data['ice'].storage, 'text-excess':costTo250.ice.count <= getStorageCap('ice') && costTo250.ice.count > data['ice'].storage, 'text-danger':costTo250.ice.count > getStorageCap('ice') }"><format-number :value="costTo250.ice.count" /></small>
                </div>
                <div class="col-auto text-end" style="width:75px">
                    <small v-if="data['ice'].prod <= 0" class="text-normal">---</small>
